...
'Регистрация на лендинге how-to-make-free-ecommerce: email без собаки' : function (browser) {
  browser
...
'Регистрация на лендинге how-to-make-free-ecommerce: email без домена' : function (browser) {
  browser
...
'Регистрация на лендинге how-to-make-free-ecommerce: Пустой password' : function (browser) {
  browser
...
'Регистрация на лендинге how-to-make-free-ecommerce: password кирилица' : function (browser) {
  browser
...
'Регистрация на лендинге how-to-make-free-ecommerce:  Название латиница' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  Название спецсимволы' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  Имя латиница' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  Имя спецсимволы' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  email кирилица' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  email спецсимволы' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
...
'Регистрация на лендинге how-to-make-free-ecommerce:  Пароль спецсимволы' : function (browser) {
  browser
  .url(refUrl) // подрубаем к сессии рефералку
